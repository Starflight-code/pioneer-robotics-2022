...
bool held_R1 = false; // Held tracks the current E-CONTROLLER_DIGITAL_R1 state; Halfcourt
bool held_R2 = false; // Held tracks the current E-CONTROLLER_DIGITAL_R2 state; Point-Blank
