...
const int numberOfMotorsPerSide = 2,
          ...
          rightMotorPorts[numberOfMotorsPerSide] = {3, 4};
...
class motors {
    public:
        ...
        void motorInit(){
        pros::Motor front_left(leftMotorPorts[0],false); // Motor: Normal
        pros::Motor front_right(rightMotorPorts[0],true); // Motor: Reversed
        pros::Motor rear_left(leftMotorPorts[1],false); // Motor: Normal
        pros::Motor rear_right(rightMotorPorts[1],true); // Motor: Reversed
        }
